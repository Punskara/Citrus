<header>
    ...
    <nav>
        <a href="<?php url_to( 'install/main/installation' ) ?>">
            Installation</a>
        <a href="<?php url_to( 'install/main/configuration' ) ?>" id="configuration" class="disabled">
            Configuration
        </a>
        <a href="<?php url_to( 'install/main/apps' ) ?>" id="apps" class="disabled">
            Apps
        </a>
    </nav>
</header>
...
<footer></footer>
<script type="text/javascript" src="<?php echo url_to( 'install/main/getconfig.json' ) ?>"></script>
